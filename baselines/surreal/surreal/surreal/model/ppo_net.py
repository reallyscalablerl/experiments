...
class PPOModel(nnx.Module):
    ...
    def update_target_params(self, net):
        ...
        '''
        if self.ddp and not net.ddp:
            self.actor.module.load_state_dict(net.actor.state_dict())
            self.critic.module.load_state_dict(net.critic.state_dict())
        elif not self.ddp and net.ddp:
            self.actor.load_state_dict(net.actor.module.state_dict())
            self.critic.load_state_dict(net.critic.module.state_dict())
        else:
