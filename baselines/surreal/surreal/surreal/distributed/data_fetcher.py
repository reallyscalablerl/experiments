...
class LearnerDataPrefetcher(DataFetcher):
    ...
    rank,
        ...
        self.sampler_port = str(int(os.environ['SYMPH_SAMPLER_FRONTEND_PORT']) + rank * 100)
        self.batch_size = batch_size
        self.prefetch_processes = session_config.learner.prefetch_processes
        self.prefetch_host = '127.0.0.1'
        self.worker_comm_port = str(int(os.environ['SYMPH_PREFETCH_QUEUE_PORT']) + rank * 100)
